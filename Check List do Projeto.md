...
[ ] 2.2 Seção Quem Somos na Home: Inserir resumo da história e sócios.

[ ] 2.3 Seção Serviços na Home: Reorganizar a ordem dos serviços para colocar Direito Bancário entre os 3 primeiros.

[ ] 2.4 Seção Depoimentos / Avaliações do Google: Criar o bloco de "Opinião de nossos clientes" com estilo de avaliações do Google Meu Negócio.

[ ] 2.5 Seção Contato + Mapa na Home: Integrar o formulário de contato e o mapa na parte inferior da Home.
